...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo get_url('home.php'); ?>">music_db</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <?php if (is_logged_in()) : ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo get_url('add_song_to_database.php'); ?>">Add Song</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo get_url('view_songs.php'); ?>">View Songs</a>
                    </li>
                <?php endif; ?>
                <?php if (!is_logged_in()) : ?>
                    <li class="nav-item">
